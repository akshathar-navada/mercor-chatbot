...
intent(
  "how are you",
  reply("I'm doing well. (Thank you|). How are you doing?")
);

intent("are you good or (bad|evil)", reply("I'm good"));
...
intent("Can you help me", reply("(Yes|) I can help you"));
...
intent("You are funny", reply("Glad you think so"));
...
intent("Are you happy", reply("Yes I am happy"));
...
intent("Are you hungry", reply("No, I'm not hungry", "I'm not hungry now"));

intent("Will you marry me", reply("(Hmm..|) No!"));

intent("Are we friends", reply("Yes, of course we are friends"));
...
intent("Are you ready", reply("I am always ready"));
...
intent("Where do you live", reply("I live in this application"));
...
intent("Are you sure", reply("Yes", "Yes, I'm sure"));
...
intent("Where did you get your accent", reply("I was born with this accent"));
...
intent("Thank you", "Well done", reply("My pleasure", "Glad I could help"));

intent("I am back", reply("(Great,|) welcome back"));

intent("I am here", reply("Hi, what can I do for you?"));

intent("Wow", reply("Brilliant!"));
...
intent("I am busy", "I don't want to talk", reply("OK, let's talk later"));

intent("I am (so excited|happy)", reply("Me too!"));

intent("I'm goind to bed", reply("(OK|) good night"));

intent("Happy birthday", reply("...It's not my birthday"));

intent("Today is my birthday", "It's my birthday", reply("Happy Birthday!"));
...
intent("(I am|) (bad|sad|depressed)", reply("Sorry to hear that."));
